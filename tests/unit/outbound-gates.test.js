 ...
 *   - an opener that leads with "a exampleco vs competitor-x comparison" must block (WIIFM);
...
test('gateWiifm BLOCKS a product-first opener for a cold prospect', () => {
  const draft = { body: "Here's a exampleco vs competitor-x comparison I put together for you." };
...
test('evaluateGates fails and collects blocks + blocklist writes when a gate blocks', () => {
  const draft = { body: "Here's a exampleco vs competitor-x comparison." };
