...
const LEGACY = {
  ...
  text: 'exampleco builds a compliant draft roster for a manager to review before publishing.',
  segment: 'hospitality, retail',
  source_title: 'Roster Agent', source_url: 'https://help.exampleco.co/',
...
test('product-knowledge schema: accepts each new type (objection / pain / battlecard)', () => {
  ...
  assert.ok(entryOk(v, {
    ...
    response: 'exampleco feeds payroll, it does not replace it.', role: 'finance',
