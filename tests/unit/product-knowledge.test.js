...
const STORE = [
  ...
  { id: 'BC', type: 'battlecard', competitor: 'competitor-x', role: 'owner', segment: 'general', differentiation: 'award automation', guardrail: 'differentiation only', text: 'vs competitor-x', source_type: 'public', approved: true, last_verified: FRESH },
...
test('validateVocabTags rejects free-text role/segment/competitor', () => {
  assert.equal(pk.validateVocabTags({ role: 'finance', segment: 'hospitality, retail', competitor: 'competitor-x' }).ok, true);
