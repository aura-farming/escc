/*
 * Adapted from Everything Claude Code (ECC) scripts/lib/install/apply.js
 * (MIT, (c) Affaan Mustafa) https://github.com/affaan-m/ECC.
 * Re-namespaced ECC_*->ESCC_*.
 *
 * Applies a resolved install plan to disk: copies managed files, deep-merges
 * JSON configs, filters MCP servers disabled via ESCC_DISABLED_MCPS, resolves
 * ${CLAUDE_PLUGIN_ROOT} placeholders in claude/claude-project hooks, and writes
...
function applyInstallPlan(plan) {
  ...
  const disabledServers = parseDisabledMcpServers(process.env.ESCC_DISABLED_MCPS);
